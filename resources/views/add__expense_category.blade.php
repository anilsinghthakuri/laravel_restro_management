                ...
                <table class="table table-bordered bg-light table-responsiv">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                <a href="/expense-category/{{$item->expense_category_id}}"><button type="button" class="btn btn-primary action-btn"><i class="fas fa-edit" aria-hidden="true"></i></button></a>

                                <a href="/expense-category-delete/{{$item->expense_category_id}}"><button type="button" class="btn btn-danger action-btn"><i class="far fa-trash-alt"
